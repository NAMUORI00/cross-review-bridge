...
- OpenAI Codex plugin docs position plugins as the distribution path when bundling reusable skills with app integrations, MCP configuration, or presentation assets.
